...
const Bubbles = () => {
  return (
    <>
      ...
      <Bubble inputSize="30px" inputPositon="90vw" inputDelay="-20s" />
      <Bubble inputSize="25px" inputPositon="40vw" inputDelay="8s" />
      <Bubble inputSize="20px" inputPositon="60vw" inputDelay="-12s" />
      <Bubble inputSize="15px" inputPositon="30vw" inputDelay="-16s" />
      <Bubble inputSize="10px" inputPositon="80vw" inputDelay="-4s" />
      <Bubble inputSize="30px" inputPositon="80vw" inputDelay="-12s" />
      <Bubble inputSize="25px" inputPositon="30vw" inputDelay="16s" />
      <Bubble inputSize="20px" inputPositon="50vw" inputDelay="-20s" />
      <Bubble inputSize="15px" inputPositon="100vw" inputDelay="40s" />
      <Bubble inputSize="10px" inputPositon="70vw" inputDelay="0s" />
    </>
  );
};
